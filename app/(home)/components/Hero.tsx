    ...
    <div className='min-h-[60vh] flex gap-10 flex-col-reverse lg:flex-row lg:gap-0 items-center justify-between'>
        ...
        <div>
            <div className='w-full  py-2 px-4'>
                 <div>
                    <Image src={Profile}   className=' rounded-xl object-cover  h-[55vh] w-[50vw]  lg:h-[55vh] lg:w-[20vw] ' alt={'profile image'}/>
                 </div>
               

                <div className='glow absolute top-[110px] right-1/2 -z-10'>
